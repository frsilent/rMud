//string functions not in stdlib
...
std::string ParseWord( const std::string& p_string, int p_index )
{
    ...
    while( p_index > 0 )
    {
        ...
        // find beginning of the next word by finding whitespace to end current word
		//then non-whitespace at the start of the next word
